...
from .views import inicio, loginsexo, tienda, registro, logout_view, agregar_al_carrito, ver_carrito, eliminar_item_carrito, plumbusX, clientes, contacto, adminInicio
